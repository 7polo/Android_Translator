...
public class NetConnection {
    ...
    public void setConfig(Userbean userbean) {
        this.keyform = userbean.getKeyfrom();
        this.key = userbean.getKey();
    }

    public ResultBean doQuery() {
        try {
            requestString = new StringBuilder(queryURI + "?keyfrom=" +
                    this.keyform + "&key=" + this.key + "&type=data&doctype=" + doctype + "&version=1.1&q=");
